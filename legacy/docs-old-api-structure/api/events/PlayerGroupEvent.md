...
- [`PlayerPermissionChangeEvent`](./PlayerPermissionChangeEvent.md) -- The parent class. Also has `GroupAdded` / `GroupRemoved` inner events.
- [`GroupPermissionChangeEvent`](./GroupPermissionChangeEvent.md) -- Fired when the group's own permissions change (as opposed to membership changes).
