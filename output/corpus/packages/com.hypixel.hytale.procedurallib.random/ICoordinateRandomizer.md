...
Type: interface | Package: com.hypixel.hytale.procedurallib.random

public interface ICoordinateRandomizer

Defines the contract for ICoordinateRandomizer operations. Provides coordinate-based random value generation for procedural content.
