---
title: "ConstantCellJitter"
kind: "class"
package: "com.hypixel.hytale.procedurallib.logic.cell.jitter"
fqcn: "com.hypixel.hytale.procedurallib.logic.cell.jitter.ConstantCellJitter"
api_surface: false
extends: null
...
| `@Override public` | `double` | `getPointX(int cx, DoubleArray.Double2 vec)` |
| `@Override public` | `double` | `getPointY(int cy, DoubleArray.Double2 vec)` |
| `@Override public` | `double` | `getPointX(int cx, DoubleArray.Double3 vec)` |
