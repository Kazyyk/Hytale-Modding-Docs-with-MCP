...
Asset defining a builder tool with configurable arguments and optional brush data. Tools are loaded from JSON and associated with items via [BuilderToolData](BuilderToolData.md). Supports runtime argument updates, item metadata serialization, and network packet conversion.
