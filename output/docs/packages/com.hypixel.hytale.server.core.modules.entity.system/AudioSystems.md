...
fqcn: "com.hypixel.hytale.server.core.modules.entity.system.AudioSystems"
api_surface: false
extends: ~
implements: []
...
- [EntitySystems](EntitySystems.md) -- other entity system containers in this package
- [TransformSystems](TransformSystems.md) -- transform tracker update follows a similar pattern
