---
title: "LegacyEntityTrackerSystems"
kind: "class"
package: "com.hypixel.hytale.server.core.modules.entity.tracker"
fqcn: "com.hypixel.hytale.server.core.modules.entity.tracker.LegacyEntityTrackerSystems"
api_surface: false
extends: ~
implements: []
...
Container class for legacy entity tracker ECS systems that handle network synchronization of visual properties (models, skins, equipment) and visibility filtering (hiding, LOD culling). These systems operate on the `Visible` component from [EntityTrackerSystems](EntityTrackerSystems.md) and queue updates to viewers via the `EntityViewer.queueUpdate()` method.
...
- [EntityTrackerSystems](EntityTrackerSystems.md) -- core visibility and packet systems that these legacy systems build upon
- [EntityTrackerSystems.Visible](EntityTrackerSystems.md#visible) -- the visibility component all inner systems read
- [EntityTrackerSystems.EntityViewer](EntityTrackerSystems.md#entityviewer) -- the viewer component used for update queuing
- [NetworkId](NetworkId.md) -- network identifier assigned to tracked entities
