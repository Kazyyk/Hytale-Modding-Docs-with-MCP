...
Also in this package: CountObjectiveTask, CraftObjectiveTask, GatherObjectiveTask, InventoryChangeAware, ObjectiveTask, ObjectiveTaskRef, ReachLocationTask, UseBlockObjectiveTask, UseEntityObjectiveTask
...
Complete API:
  ...
  private Ref<ChunkStore> spawnChestBlock(World world, Vector3i conditionPosition, String chestBlockTypeKey, SpawnTreasureChestTransactionRecord transactionRecord)
