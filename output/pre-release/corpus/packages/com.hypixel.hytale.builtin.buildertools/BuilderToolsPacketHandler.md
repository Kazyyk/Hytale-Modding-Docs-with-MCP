...
Complete API:
  ...
  public void handleBuilderToolResetClipboardRotation(BuilderToolResetClipboardRotation packet, PlayerRef playerRef, Ref<EntityStore> ref, World world, Store<EntityStore> store)
  ...
  public void handlePrefabSetAnchor(PrefabSetAnchor packet, PlayerRef playerRef, Ref<EntityStore> ref, World world, Store<EntityStore> store)
