...
Complete API:
  ...
  public short getTempPathLength()
  public void initialise(UUID id, String pathName, int index, double pauseTime, float observationAngle, int worldGenId, ComponentAccessor<EntityStore> componentAccessor)
