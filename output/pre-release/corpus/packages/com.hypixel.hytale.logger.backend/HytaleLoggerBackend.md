...
Also in this package: HytaleConsole, HytaleFileHandler, HytaleJdkLogger, HytaleLogFormatter, HytaleLogManager, HytaleUncaughtExceptionHandler, RawLogRecord
...
Complete API:
  ...
  public void log(LogRecord logRecord, boolean sentryHandled)
  public static void subscribe(CopyOnWriteArrayList<LogRecord> subscriber)
  public static void unsubscribe(CopyOnWriteArrayList<LogRecord> subscriber)
  ...
  public void loadLogLevel()
  public static void loadLevels(List<Entry<String,Level>> list)
  public static void reloadLogLevels()
  public static HytaleLoggerBackend getLogger()
  public static HytaleLoggerBackend getLogger(String name)
