...
Also in this package: BorderPointEvaluator, DensityPointEvaluator, Direction, DistancePointEvaluator, JitterPointEvaluator, Mode, NormalPointEvaluator, PointEvaluator, SkipCellPointEvaluator

Complete API:
  public CellJitter getJitter()
  public void evalPoint(int seed, double x, double y, int hashA, int cax, int cay, double ax, double ay, ResultBuffer.ResultBuffer2d buffer)
