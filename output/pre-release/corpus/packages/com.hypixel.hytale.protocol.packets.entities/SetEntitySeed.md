...
Also in this package: ApplyKnockback, ChangeVelocity, EntityUpdates, MountMovement, PlayAnimation, PlayEmote, SpawnModelParticles

Complete API:
  public int getId()
  public NetworkChannel getChannel()
  public static SetEntitySeed deserialize(ByteBuf buf, int offset)
