...
Also in this package: ApplyKnockback, ChangeVelocity, EntityUpdates, MountMovement, PlayAnimation, PlayEmote, SetEntitySeed

Complete API:
  public int getId()
  public NetworkChannel getChannel()
  public static SpawnModelParticles deserialize(ByteBuf buf, int offset)
