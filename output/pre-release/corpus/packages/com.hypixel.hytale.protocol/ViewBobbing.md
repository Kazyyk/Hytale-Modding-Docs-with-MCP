...
Deserializes a `ViewBobbing` from the given buffer at the specified offset.


public static int computeBytesConsumed(@Nonnull ByteBuf buf, int offset)

Returns the total number of bytes consumed by this `ViewBobbing` starting at the given offset.


public void serialize(@Nonnull ByteBuf buf)

Serializes this `ViewBobbing` into the given buffer.
...
Complete API:
  public static ViewBobbing deserialize(ByteBuf buf, int offset)
