...
Also in this package: AssetNotifications, AssetPackRegisterEvent, AssetPackUnregisterEvent, AssetRegistryLoader, AssetStoreMonitorHandler, Builder, HytaleAssetStore, LoadAssetEvent
...
Complete API:
  ...
  public boolean validatePackExistsOnDisk(AssetPack pack)
