...
Event fired when an asset pack is unregistered from the server.

## Methods

- public AssetPack getAssetPack()

Also in this package: AssetModule, AssetNotifications, AssetPackRegisterEvent, AssetRegistryLoader, AssetStoreMonitorHandler, Builder, HytaleAssetStore, LoadAssetEvent
