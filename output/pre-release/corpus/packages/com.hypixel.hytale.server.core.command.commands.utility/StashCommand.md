...
Complete API:
  ...
  private ItemContainerBlock getItemContainerState(Ref<EntityStore> ref, World world, CommandContext context, ComponentAccessor<EntityStore> componentAccessor)
