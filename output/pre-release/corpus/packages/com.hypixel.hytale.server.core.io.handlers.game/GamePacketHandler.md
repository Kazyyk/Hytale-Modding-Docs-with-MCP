...
Complete API:
  ...
  public void handlePlayEmote(PlayEmote packet, PlayerRef playerRef, Ref<EntityStore> ref, World world, Store<EntityStore> store)
...
private static final int MAX_INTERACTION_QUEUE_SIZE
