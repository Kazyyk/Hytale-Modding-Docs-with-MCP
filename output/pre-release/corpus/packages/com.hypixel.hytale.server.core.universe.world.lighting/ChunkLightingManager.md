...
Also in this package: CalculationResult, FloodLightCalculation, FullBrightLightCalculation, LightCalculation
...
Complete API:
  ...
  public boolean invalidateLightInChunk(ChunkStore chunkStore, int chunkX, int chunkZ)
  public boolean invalidateLightInChunkSection(ChunkStore chunkStore, int chunkX, int chunkZ, int sectionIndex)
  public void invalidateLoadedChunks()
