...
Complete API:
  ...
  boolean invalidateLightAtBlock(ChunkStore var1, int var2, int var3, int var4, BlockType var5, int var6, int var7)
  boolean invalidateLightInChunkSections(ChunkStore var1, int var2, int var3, int var4, int var5)
