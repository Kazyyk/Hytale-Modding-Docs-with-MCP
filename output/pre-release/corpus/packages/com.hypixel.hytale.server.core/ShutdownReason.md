...
Also in this package: AuthMode, AuthModeConverter, Constants, Defaults, HytaleServer, HytaleServerConfig, LevelValueConverter, MaybeBoolCodec, Message, Module, NameMatching, Options, ParamValueCodec, PathConverter, PathType, RecoveryMode, SocketAddressValueConverter, StringToPathMapConverter, TimeoutProfile, UUIDConverter

Complete API:
  public int getExitCode()
  public String getMessage()
  public FormattedMessage getFormattedMessage()
  public ShutdownReason withMessage(Message message)
...
public static final ShutdownReason VERIFY_ERROR
