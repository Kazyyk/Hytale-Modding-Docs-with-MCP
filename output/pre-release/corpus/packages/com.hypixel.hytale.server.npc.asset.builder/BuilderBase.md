...
Complete API:
  ...
  public boolean getOverride(JsonElement data, String name, Consumer<FeatureOverride> setter, BuilderDescriptorState state, String shortDescription, String longDescription)
  public boolean getOverride(JsonElement data, String name, EnumHolder<FeatureOverride> enumHolder, BuilderDescriptorState state, String shortDescription, String longDescription)
