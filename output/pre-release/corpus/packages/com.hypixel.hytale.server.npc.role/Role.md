...
Also in this package: AvoidanceMode, DeferredAction, RoleDebugDisplay, RoleDebugFlags, RoleDebugPreset, RoleUtils, SeparationMode, SpawnEffect
...
Complete API:
  ...
  public void blendSeparation(Ref<EntityStore> selfRef, Vector3d position, Vector3f rotation, Steering steering, ComponentType<EntityStore,TransformComponent> transformComponentType, CommandBuffer<EntityStore> commandBuffer)
  private void computeSummedDistanceLegacy(Ref<EntityStore> selfRef, Vector3d position, ComponentType<EntityStore,TransformComponent> transformComponentType, CommandBuffer<EntityStore> commandBuffer, Ref<EntityStore> ignoredTargetRef, Role.SeparationMode separationMode)
  private void scaleSummedDistanceLegacy(Vector3f rotation, Steering steering)
  private void computeSummedDistancePush(Ref<EntityStore> selfRef, Vector3d position, ComponentType<EntityStore,TransformComponent> transformComponentType, CommandBuffer<EntityStore> commandBuffer, Ref<EntityStore> ignoredTargetRef)
  private void scaleSummedDistancesPush(Vector3d position, Vector3f rotation, Steering steering, CommandBuffer<EntityStore> commandBuffer)
  public Vector3d getLastSeparationSteering()
  public void blendAvoidance(Ref<EntityStore> ref, Vector3d position, Vector3f rotation, Steering steering, CommandBuffer<EntityStore> commandBuffer)
  ...
  private void initialiseInventories(NPCEntity npcComponent, Holder<EntityStore> holder)
  private void initialiseInventories(NPCEntity npcComponent, ComponentAccessor<EntityStore> accessor, Ref<EntityStore> ref)
  private void initialiseItemsAndArmor(NPCEntity npcComponent)
  private void initialiseInventories(Ref<EntityStore> ref, NPCEntity npcComponent, ComponentAccessor<EntityStore> componentAccessor)
...
private static final double MIN_SEPARATION_SUMMED_SQUARED
...
protected final Vector3d separationTempDistanceVector
protected final Vector3d separationTempSteeringVector
...
protected final Vector3d separationSummedDistances
