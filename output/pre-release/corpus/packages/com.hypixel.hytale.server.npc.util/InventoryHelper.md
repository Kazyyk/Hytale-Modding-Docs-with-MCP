...
Complete API:
  ...
  public static boolean clearItemInHand(Ref<EntityStore> ref, Inventory inventory, byte slotHint, ComponentAccessor<EntityStore> componentAccessor)
  ...
  public static void setHotbarSlot(Ref<EntityStore> ref, Inventory inventory, byte slot, ComponentAccessor<EntityStore> componentAccessor)
  public static void setOffHandSlot(Ref<EntityStore> ref, Inventory inventory, byte slot, ComponentAccessor<EntityStore> componentAccessor)
  public static void setOffHandSlot(Holder<EntityStore> holder, Inventory inventory, byte slot)
  ...
  public static boolean useItem(Ref<EntityStore> ref, Inventory inventory, String name, byte slotHint, ComponentAccessor<EntityStore> componentAccessor)
  public static ItemStack createItem(String name)
  public static boolean useItem(Ref<EntityStore> ref, Inventory inventory, String name, ComponentAccessor<EntityStore> componentAccessor)
