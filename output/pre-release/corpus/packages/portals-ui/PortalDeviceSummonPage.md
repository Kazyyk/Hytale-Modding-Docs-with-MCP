...
Complete API:
  ...
  private static CompletableFuture<Transform> getSpawnTransform(PortalType portalType, World world, UUID sampleUuid)
  ...
  private static ItemStack decrementItemInHand(Inventory inventory, int amount)
