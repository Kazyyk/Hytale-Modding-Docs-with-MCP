---
title: "ArchetypeChunk"
kind: "class"
package: "com.hypixel.hytale.component"
fqcn: "com.hypixel.hytale.component.ArchetypeChunk"
api_surface: true
...
Columnar storage for entities that share the same [Archetype](Archetype.md). Components are stored in parallel arrays indexed by entity position within the chunk, enabling cache-friendly iteration. Each chunk holds a `Ref` array and a 2D component array (`Component[componentTypeIndex][entityIndex]`).
...
Adds an entity's data from a [Holder](Holder.md). Returns the entity's index within this chunk.
...
- [Archetype](Archetype.md) -- defines which component types this chunk stores
- [Store](Store.md) -- owns and manages archetype chunks
- [Ref](Ref.md) -- identifies entities within the chunk
