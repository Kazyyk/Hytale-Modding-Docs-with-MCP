...
| `BuilderToolArgGroup` | enum | Groups for builder tool arguments.... |
...
| `BuilderToolBrushData` | class | Complete brush configuration data containing dimensions, shape, origin, rotation... |
