...
fqcn: "com.hypixel.hytale.protocol.ConnectedBlockRuleSet"
api_surface: false
extends: ~
implements: []
...
|---|---|---|---|
| [ConnectedBlockRuleSetType](ConnectedBlockRuleSetType.md) | `type` | No |  Default: `ConnectedBlockRuleSetType.Stair`. |
| [StairConnectedBlockRuleSet](StairConnectedBlockRuleSet.md) | `stair` | Yes |  |
| [RoofConnectedBlockRuleSet](RoofConnectedBlockRuleSet.md) | `roof` | Yes |  |
...
- [ConnectedBlockRuleSetType](ConnectedBlockRuleSetType.md)
