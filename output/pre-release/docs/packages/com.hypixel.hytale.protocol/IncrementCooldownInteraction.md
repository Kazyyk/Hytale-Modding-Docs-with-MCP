...
fqcn: "com.hypixel.hytale.protocol.IncrementCooldownInteraction"
api_surface: false
...
| `float` | `cooldownIncrementTime` | No |  |
| `int` | `cooldownIncrementCharge` | No |  |
| `float` | `cooldownIncrementChargeTime` | No |  |
| `boolean` | `cooldownIncrementInterrupt` | No |  |
