...
fqcn: "com.hypixel.hytale.protocol.ItemCategory"
api_surface: false
extends: ~
implements: []
...
| `String` | `icon` | Yes |  |
| `int` | `order` | No |  |
| [ItemGridInfoDisplayMode](ItemGridInfoDisplayMode.md) | `infoDisplayMode` | No |  Default: `ItemGridInfoDisplayMode.Tooltip`. |
| [ItemCategory](ItemCategory.md)`[]` | `children` | Yes |  |
