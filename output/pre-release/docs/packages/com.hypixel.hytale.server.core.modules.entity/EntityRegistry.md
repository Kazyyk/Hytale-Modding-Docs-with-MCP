...
fqcn: "com.hypixel.hytale.server.core.modules.entity.EntityRegistry"
api_surface: true
...
**Returns:** An [EntityRegistration](EntityRegistration.md) handle, or `null` if the underlying [EntityModule](EntityModule.md) is disabled.
...
- [EntityRegistration](EntityRegistration.md) -- the handle returned by registration
- [EntityModule](EntityModule.md) -- performs the actual entity registration
