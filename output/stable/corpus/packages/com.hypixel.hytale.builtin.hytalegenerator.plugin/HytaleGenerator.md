...
Complete API:
  ...
  public NStagedChunkGenerator createStagedChunkGenerator(ChunkRequest.GeneratorProfile generatorProfile, WorldStructureAsset worldStructureAsset, SettingsAsset settingsAsset)
