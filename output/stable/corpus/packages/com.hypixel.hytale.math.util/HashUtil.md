...
Also in this package: ChunkUtil, FastRandom, Icecore, IterationElement, MathUtil, NearestBlockUtil, NumberUtil, Riven, TrigMathUtil
...
Complete API:
  ...
  public static int randomInt(long l1, long l2, long l3, int bound)
  private static double hashToRandomDouble(long hash)
  public static long hashUuid(UUID uuid)
