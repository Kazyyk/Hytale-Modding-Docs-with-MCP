...
Also in this package: DropCreativeItem, DropItemStack, InventoryAction, MoveItemStack, SetActiveSlot, SetCreativeItem, SmartGiveCreativeItem, SmartMoveItemStack, UpdatePlayerInventory

Complete API:
  public int getId()
  public NetworkChannel getChannel()
  public static SwitchHotbarBlockSet deserialize(ByteBuf buf, int offset)
