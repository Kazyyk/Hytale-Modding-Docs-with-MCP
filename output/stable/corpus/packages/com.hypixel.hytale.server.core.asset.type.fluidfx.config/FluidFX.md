...
Type: class | Package: com.hypixel.hytale.server.core.asset.type.fluidfx.config | Implements: JsonAssetWithMap<String, IndexedLookupTableAssetMap<String, FluidFX>>, NetworkSerializable<com.hypixel.hytale.protocol.FluidFX>
