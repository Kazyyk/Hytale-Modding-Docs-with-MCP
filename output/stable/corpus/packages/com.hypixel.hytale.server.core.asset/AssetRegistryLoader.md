...
Also in this package: AssetModule, AssetNotifications, AssetPackRegisterEvent, AssetPackUnregisterEvent, AssetStoreMonitorHandler, Builder, GenerateSchemaEvent, HytaleAssetStore, LoadAssetEvent

Complete API:
  public static void init()
  public static void preLoadAssets(LoadAssetEvent event)
  public static void loadAssets(LoadAssetEvent event, AssetPack assetPack)
  ...
  public static Map<String,Schema> generateSchemas(SchemaContext context, BsonDocument vsCodeConfig)
