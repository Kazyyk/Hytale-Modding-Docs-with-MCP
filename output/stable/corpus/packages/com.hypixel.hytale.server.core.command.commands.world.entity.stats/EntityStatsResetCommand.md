...
Also in this package: EntityStatsAddCommand, EntityStatsDumpCommand, EntityStatsGetCommand, EntityStatsSetCommand, EntityStatsSetToMaxCommand, EntityStatsSubCommand

Complete API:
  protected void execute(CommandContext context, ObjectList<Ref<EntityStore>> entities, World world, Store<EntityStore> store)
  public static void resetEntityStat(CommandContext context, List<Ref<EntityStore>> entities, String entityStat, Store<EntityStore> store)
