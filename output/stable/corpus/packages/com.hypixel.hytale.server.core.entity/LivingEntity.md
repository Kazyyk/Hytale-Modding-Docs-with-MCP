...
Complete API:
  ...
  public ItemStackSlotTransaction decreaseItemStackDurability(Ref<EntityStore> ref, ItemStack itemStack, int inventoryId, int slotId, ComponentAccessor<EntityStore> componentAccessor)
