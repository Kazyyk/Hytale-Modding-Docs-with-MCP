...
- @Nonnull private static final Message MESSAGE_COMMANDS_DEBUG_SHAPE_CLEAR_SUCCESS
...
Also in this package: DebugCommand, DebugShapeArrowCommand, DebugShapeConeCommand, DebugShapeCubeCommand, DebugShapeCylinderCommand, DebugShapeShowForceCommand, DebugShapeSphereCommand, DebugShapeSubCommand

Complete API:
  protected void execute(CommandContext context, Store<EntityStore> store, Ref<EntityStore> ref, PlayerRef playerRef, World world)

Fields:
private static final Message MESSAGE_COMMANDS_DEBUG_SHAPE_CLEAR_SUCCESS
