...
Type: class | Package: com.hypixel.hytale.server.core.prefab.selection.mask | Extends: BlockMask

public class MultiBlockMask extends BlockMask

Extends BlockMask to combine multiple independent mask instances. A block is excluded if any of the contained masks excludes it (logical OR, then XOR with the global inversion flag).
