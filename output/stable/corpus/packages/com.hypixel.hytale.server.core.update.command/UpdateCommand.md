...
Parent command for server update operations.

Also in this package: SetPatchlineVariant, UpdateApplyCommand, UpdateCancelCommand, UpdateCheckCommand, UpdateDownloadCommand, UpdatePatchlineCommand, UpdateStatusCommand
