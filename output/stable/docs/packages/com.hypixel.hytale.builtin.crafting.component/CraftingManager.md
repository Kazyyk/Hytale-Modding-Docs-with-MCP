...
fqcn: "com.hypixel.hytale.builtin.crafting.component.CraftingManager"
api_surface: false
extends: ~
implements: 
...
- [CraftingManager.CraftingJob](CraftingManager.CraftingJob.md) -- tracks a queued crafting operation
- [CraftingManager.BenchUpgradingJob](CraftingManager.BenchUpgradingJob.md) -- tracks a bench tier upgrade
- [CraftingManager.ChestLookupResult](CraftingManager.ChestLookupResult.md) -- result of nearby chest spatial query
- [CraftingManager.InputRemovalType](CraftingManager.InputRemovalType.md) -- enum controlling input removal strategy
