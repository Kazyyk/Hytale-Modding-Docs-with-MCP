...
Package-private pure simplex noise implementation providing static methods for 2D, 3D, and 4D noise evaluation. This is a standard simplex noise algorithm using gradient tables and a 256-entry permutation table. Used internally by [SimplexNoiseField](SimplexNoiseField.md) for per-octave noise evaluation.
...
- [SimplexNoiseField](SimplexNoiseField.md) -- uses this class for per-octave noise sampling
- [NoiseField](NoiseField.md) -- abstract base class for all noise fields
