...
| Type | Description |
|---|---|
| [BoxProp](BoxProp.md) | Prop that places a filled box of material at scanned positions |
| [ClusterProp](ClusterProp.md) | Prop that places clusters of weighted child props using density and seed-based randomization |
| [ColumnProp](ColumnProp.md) | Prop that places vertical columns with configurable height, material, and directionality |
...
| [PositionListScanResult](PositionListScanResult.md) | Scan result containing a list of valid placement positions |
| [PositionScanResult](PositionScanResult.md) | Scan result containing a single valid placement position |
...
| Type | Description |
|---|---|
| [ScanResult](ScanResult.md) | Interface for prop scan results indicating whether placement is valid |
