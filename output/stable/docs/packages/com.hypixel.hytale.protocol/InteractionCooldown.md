...
fqcn: "com.hypixel.hytale.protocol.InteractionCooldown"
api_surface: true
extends: ~
implements: []
...
| `float` | `cooldown` | No |  |
| `boolean` | `clickBypass` | No |  |
| `float``[]` | `chargeTimes` | Yes |  |
| `boolean` | `skipCooldownReset` | No |  |
| `boolean` | `interruptRecharge` | No |  |
