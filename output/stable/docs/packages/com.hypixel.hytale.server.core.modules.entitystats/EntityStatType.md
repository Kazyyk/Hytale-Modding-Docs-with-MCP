...
implements:
  ...
  - "NetworkSerializable<EntityStatType>"
...
- [EntityStatType.EntityStatEffects](EntityStatType.EntityStatEffects.md)
- [EntityStatType.Regenerating](EntityStatType.Regenerating.md)
